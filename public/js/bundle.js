  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email, password, passwordConfirm) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            (0, _alerts.showAlert)('success', "Created new user with name: ".concat(name));
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'POST',
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Created new account');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            } //console.log(res);
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW54aW91c3YiLCJhIjoiY2tzdm9zNnFmMXNvNTJubWQ5Z3p5NzNhcSJ9.VDJLltXdvuxWPTAjgno99w';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/anxiousv/cksvqmpdc0uj717ns9l83h2ar',
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "User ".concat(type, " was successfully updated"));
            }
...
var stripe = Stripe('pk_test_51JUu9zKwBueMRZzCerIpdo2QmPbEkXkUDXJpMKty7OAgHMrIiLSt34tuQv9jpBzDZkmGYHEiM340iJp6unyXE0g700unXY8ie7');
